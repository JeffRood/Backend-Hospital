...
app.get('/', (req, res, next) => {
    ...
    Hospital.find({}).skip(desde).limit(5).populate('usuario', 'nombre email').exec((err, hospitales) => {
        ...
        // hace un conteo de los registro que tengo almacenado
...
// ===============================================
// ACTUALIZAR DATOS DE HOSPITALES mAutenticacion.verificaToken, 
//================================================
...
// ===============================================
// INSERTAR DATOS DE HOSPITALES  mAutenticacion.verificaToken,
//================================================
...
// ===============================================
// BORRAR HOSPITALES  mAutenticacion.verificaToken,
//================================================ 
